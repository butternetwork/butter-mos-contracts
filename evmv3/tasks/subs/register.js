...
task("register:setTransferOutFee", "set transfer outFee")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        await register.setTransferOutFee(taskArgs.token, taskArgs.chain, min, max, rate, {gasLimit: 150000});
...
task("register:setTokenFee", "set token outFee")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        await register.setTokenFee(taskArgs.token, taskArgs.chain, min, max, rate, {gasLimit: 150000});
