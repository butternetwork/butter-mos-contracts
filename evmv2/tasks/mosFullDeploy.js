module.exports = async (taskArgs, hre) => {
    ...
    await (await mos.connect(deployer).registerToken(stablecoinAddress, 5, true)).wait();
    await (await mos.connect(deployer).registerToken(stablecoinAddress, 5566818579631833089, true)).wait();
