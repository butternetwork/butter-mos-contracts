...
if [ "$1" == "BscTest" ]; then
  ...
  npx hardhat mosDeploy --wrapped 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd --lightnode 0xdB913e87608e3d91C6F0b52E97a6760E7661B8f6 --network BscTest && npx hardhat swapIn --network BscTest
