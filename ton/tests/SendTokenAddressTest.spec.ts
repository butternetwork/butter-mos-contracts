...
describe('Jetton Transfer Tests', () => {
    ...
    it('should transfer tokens and trigger bridge notification', async () => {
        ...
        console.log('last sender:', await receiverWallet.getLastSender());
        console.log('Expected sender address:', deployerJettonWallet.address.toString());
        console.log('Actual last sender:', await receiverWallet.getLastSender());
    });
});